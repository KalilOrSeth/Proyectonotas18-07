<?php
include_once('../../Usuarios/modelo/usuarios.php');
$model = new  Usuario();
$model->validarsesion();
if(!$_SESSION['validar']){
...
<body style="background-image:  linear-gradient(100deg, #cbffdc 0, #baffdc 16.67%, #abffda 33.33%, #9df2d5 50%, #92e3cf 66.67%, #89d5c9 83.33%, #83c9c4 100%)">
    <nav>
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" style="background-color: red; border: solid 1px;position: relative; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;" href="../../Usuarios/modelo/salir.php">Cerrar Sesion</a>
            </li>
        </ul>
    </nav>
    <nav>
